...
def client_reddit():
    ...
    # new_table = data1.set_column(data1.schema.get_field_index('genres[1]'), 'genres[1]', replaced_genres1)
    # print(new_table)
    ...
    # replaced_genres1 = pc.fill_null(genres1, pa.scalar('No genres1'))
    # new_table = data1.set_column(data1.schema.get_field_index('genres_1'), 'genres_1]', replaced_genres1)
    # print(new_table)
